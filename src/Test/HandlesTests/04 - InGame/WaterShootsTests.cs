...
namespace Library.Tests
{
    ...
    [TestFixture]
    public class WaterShootsTests
    {
        private AttackHandle attackHandler;
        private WaterShootsHandle handler;
        ...
        public void Setup()
        {
            ...
            handler = new WaterShootsHandle(null, Printer);
        ...
        [Test]
        public void TestWaterShootHandle()
        {
            message.Text = "Disparos errados";
            message.From = userTelegram1;
