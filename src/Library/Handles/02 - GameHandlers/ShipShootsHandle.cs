...
namespace Battleship
{
    ...
    /// </summary>
    public class ShipShootsHandle : BaseHandler
    {
        ...
        public ShipShootsHandle(BaseHandler next, IPrinter printer) : base(next)
        {
            this.Keywords = new string[] {"Disparos acertados", "disparos acertados"};
        ...
        protected override void InternalHandle(Message message, out string response)
        {
            try
            {
                ...
                {                 
                    response = game.GetGameCounter().GetShipShoots().ToString();
                }
